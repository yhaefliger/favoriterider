...
Encore
    ...
    .addEntry('admin/riders/index', './assets/admin/riders/index.js')
    .addEntry('front/widget/riders', './assets/front/widget/riders.js')
    .addStyleEntry('front/home', './assets/front/hooks/home.scss')
